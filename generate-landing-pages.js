...
const MACHINES = [
    ...
    { id: "ultra_miracle_juggler", name: "ウルトラミラクルジャグラー", type: "A", bigLabel: "BIG", regLabel: "REG", koyakuName: "ブドウ",
      ...
      ceiling:null, ceilingTarget:null, ceilingReward:null, avgBonusReward:250, normalCostPerGame:1.8 },
    { id: "discup_ultraremix", name: "ディスクアップ ULTRAREMIX", type: "A", bigLabel: "BIG", regLabel: "REG", koyakuName: null,
    ...
    { id: "kabaneri", name: "甲鉄城のカバネリ", type: "AT", bigLabel: "初当たり", regLabel: "ST", koyakuName: null,
      ...
      ceiling:1000, ceilingTarget:550, ceilingReward:600, avgBonusReward:400, normalCostPerGame:2.3 },
    { id: "banchou4", name: "押忍！番長4", type: "AT", bigLabel: "初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:699, ceilingTarget:450, ceilingReward:500, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "hokuto", name: "スマスロ北斗の拳", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1268, ceilingTarget:800, ceilingReward:1500, avgBonusReward:800, normalCostPerGame:2.5 },
    { id: "karakuri", name: "からくりサーカス", type: "AT", bigLabel: "AT初当たり", regLabel: "CZ合算", koyakuName: null,
      ...
      ceiling:1200, ceilingTarget:800, ceilingReward:500, avgBonusReward:400, normalCostPerGame:2.3 },
    { id: "valvrave", name: "ヴァルヴレイヴ", type: "AT", bigLabel: "CZ初当たり", regLabel: "ボーナス", koyakuName: null,
      ...
      ceiling:1000, ceilingTarget:700, ceilingReward:400, avgBonusReward:300, normalCostPerGame:2.0 },
    { id: "monkey_turn_v", name: "モンキーターンV", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:795, ceilingTarget:500, ceilingReward:600, avgBonusReward:400, normalCostPerGame:2.4 },
    { id: "tokyo_ghoul", name: "L東京喰種", type: "AT", bigLabel: "AT初当たり", regLabel: "CZ初当たり", koyakuName: null,
      ...
      ceiling:600, ceilingTarget:350, ceilingReward:500, avgBonusReward:350, normalCostPerGame:2.2 },
    { id: "kaguya_sama", name: "かぐや様は告らせたい", type: "AT", bigLabel: "ボーナス初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1100, ceilingTarget:700, ceilingReward:1000, avgBonusReward:600, normalCostPerGame:2.0 },
    { id: "god_eater", name: "ゴッドイーター リザレクション", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1000, ceilingTarget:600, ceilingReward:1000, avgBonusReward:600, normalCostPerGame:2.3 },
    { id: "bakemonogatari", name: "スマスロ化物語", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1000, ceilingTarget:600, ceilingReward:500, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "hokuto_tensei2", name: "北斗の拳 転生の章2", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1536, ceilingTarget:900, ceilingReward:1000, avgBonusReward:600, normalCostPerGame:2.3 },
    { id: "koukaku", name: "攻殻機動隊", type: "AT", bigLabel: "AT初当たり", regLabel: "CZ初当たり", koyakuName: null,
      ...
      ceiling:999, ceilingTarget:600, ceilingReward:600, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "dmc5", name: "デビルメイクライ5", type: "AT", bigLabel: "ボーナス", regLabel: "ST", koyakuName: null,
      ...
      ceiling:1000, ceilingTarget:600, ceilingReward:800, avgBonusReward:500, normalCostPerGame:2.2 },
    { id: "hihouden", name: "秘宝伝", type: "AT", bigLabel: "初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:799, ceilingTarget:550, ceilingReward:400, avgBonusReward:300, normalCostPerGame:2.1 },
    { id: "tenken", name: "転生したら剣でした", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:970, ceilingTarget:600, ceilingReward:700, avgBonusReward:400, normalCostPerGame:2.3 },
    { id: "valvrave2", name: "ヴァルヴレイヴ2", type: "AT", bigLabel: "初当たり合算", regLabel: null, koyakuName: null,
      ...
      ceiling:1500, ceilingTarget:700, ceilingReward:1200, avgBonusReward:800, normalCostPerGame:2.0 },
    { id: "enen", name: "炎炎ノ消防隊", type: "AT", bigLabel: "初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:850, ceilingTarget:550, ceilingReward:600, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "tekken6", name: "鉄拳6", type: "AT", bigLabel: "ボーナス", regLabel: "AT初当たり", koyakuName: null,
      ...
      ceiling:900, ceilingTarget:600, ceilingReward:700, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "prism_nana", name: "プリズムナナ", type: "AT", bigLabel: "初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:899, ceilingTarget:550, ceilingReward:700, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "azurlane", name: "アズールレーン", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:2000, ceilingTarget:1200, ceilingReward:1200, avgBonusReward:600, normalCostPerGame:2.3 },
    { id: "zettai4", name: "絶対衝激IV", type: "AT", bigLabel: "ボーナス", regLabel: "AT初当たり", koyakuName: null,
    ...
    { id: "railgun2", name: "とある科学の超電磁砲2", type: "AT", bigLabel: "AT初当たり", regLabel: "CZ初当たり", koyakuName: null,
      ...
      ceiling:999, ceilingTarget:550, ceilingReward:600, avgBonusReward:400, normalCostPerGame:2.2 },
    { id: "onimusha3", name: "新鬼武者3", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1000, ceilingTarget:500, ceilingReward:700, avgBonusReward:400, normalCostPerGame:2.3 },
    { id: "zenigata5", name: "主役は銭形5", type: "AT", bigLabel: "初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:1250, ceilingTarget:800, ceilingReward:800, avgBonusReward:500, normalCostPerGame:2.3 },
    { id: "tokyo_revengers", name: "東京リベンジャーズ", type: "AT", bigLabel: "初当たり", regLabel: "AT初当たり", koyakuName: null,
      ...
      ceiling:1190, ceilingTarget:700, ceilingReward:800, avgBonusReward:500, normalCostPerGame:2.2 },
    { id: "iza_banchou", name: "いざ！番長", type: "AT", bigLabel: "初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:999, ceilingTarget:600, ceilingReward:700, avgBonusReward:400, normalCostPerGame:2.3 },
    { id: "monhan_rise", name: "モンスターハンターライズ", type: "AT", bigLabel: "AT初当たり", regLabel: null, koyakuName: null,
      ...
      ceiling:999, ceilingTarget:600, ceilingReward:700, avgBonusReward:400, normalCostPerGame:2.2 },
];
...
function buildEvTable(machine) {
    if (!machine.ceiling) return "";
    const step = 100;
    const rows = [];
    for (let g = 0; g <= machine.ceiling; g += step) {
        const evData = calculateCeilingEV(machine, g);
        if (!evData) continue;
        const yen = Math.round(evData.evYen);
        const sign = yen >= 0 ? "+" : "";
        const isTarget = g >= machine.ceilingTarget;
        const cls = yen >= 0 ? "positive" : "negative";
        const judgment = isTarget ? "&#9711;" : g >= machine.ceilingTarget - 100 ? "&#9651;" : "&#10005;";
